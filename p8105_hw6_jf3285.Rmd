...
The distribution of log(beta0_hat*beta1_hat) is slightly left-skewed with the 95% confidence interval of `r quantile(pull(bootstrap_beta, beta_product), 0.025)` and `r quantile(pull(bootstrap_beta, beta_product), 0.975)`. The distribution of r_hat_squared follows a normal distribution with the 95% confidence interval of `r quantile(pull(bootstrap_rsq, r.squared), 0.025)` and `r quantile(pull(bootstrap_rsq, r.squared), 0.975)`.
